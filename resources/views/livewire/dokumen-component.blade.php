<div class="flex justify-center mt-14">
    ...
    <!-- component -->
<div class="bg-white pb-4 px-4 shadow-lg rounded-md w-full md:w-2/3">
    <div class="flex justify-between w-full pt-6 ">
      <p class="ml-3 font-bold">Tabel Dokumen</p>
      <svg class="cursor-pointer" width="14" height="4" viewBox="0 0 14 4" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g opacity="0.4">
...
<div class="w-full flex justify-end px-2 mt-2">
      <div class="w-full sm:w-64 inline-block relative ">
        <input type="" name="" class="leading-snug border border-gray-300 block w-full appearance-none bg-gray-100 text-sm text-gray-600 py-1 px-4 pl-8 rounded-lg" placeholder="Cari" />
  ...
  <div class="overflow-x-auto mt-6 flex flex-col items-center justify-between overflow-y-scroll w-full" style="height: 50vh;">
    ...
    <table class="table-auto border-collapse w-full">
      <thead>
        <tr class="rounded-lg text-sm font-medium text-gray-700 text-left" style="font-size: 0.9674rem">
          ...
          <th class="px-4 py-2" style="background-color:#f8f8f8">Lampiran</th>
        </tr>
      </thead>
      <tbody class="text-sm font-normal text-gray-700  overflow-y-scroll" >
        <tr class="hover:bg-gray-100 border-b border-gray-200 py-10">
          ...
          <td><a href="#" class="flex items-center font-bold text-gray-700 px-3 py-2 hover:underline  transition duration-200 ease-in-out hover:text-red-500">
